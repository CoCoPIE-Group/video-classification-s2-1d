...
import os
import skvideo
skvideo.setFFmpegPath('/home/tmp00047/miniconda3/envs/co-lib-py37/bin/')
import skvideo.io
...
def create_train_video(short_side):
    with open(train_list, 'w') as f, concurrent.futures.ProcessPoolExecutor(max_workers=35) as executor:
