...
sys.path.append('/usr/local/compiler/cocogen/')
...
if __name__ == '__main__':
    ...
    xgen(training_main, run, training_script_path=training_script_path,xgen_config_path='/home/tmp00047/test/video-classification-s2-1d/s2+1d_config/xgen.json',xgen_mode = 'scaling')
